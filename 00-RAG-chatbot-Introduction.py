...
# MAGIC
# MAGIC ### Implementing RAG with Databricks Lakehouse AI Foundation models
# MAGIC
...
# MAGIC
# MAGIC <img src="https://github.com/databricks-demos/dbdemos-resources/blob/main/images/product/chatbot-rag/llm-rag-self-managed-flow-1.png?raw=true" style="float: right; width: 600px; margin-left: 10px">
# MAGIC
# MAGIC The first step is to ingest and prepare the data before we can make use of our Vector Search Index.
# MAGIC
# MAGIC We'll use the Data Engineering Lakehouse capabilities to do perform ingest our Documentation pages, split them into smaller chunks, compute the chunk embeddings and save them as a Delta Lake table.
# MAGIC
...
# MAGIC %md
# MAGIC Start the data ingestion and create a Vector Search Index: open the [01-Data-Preparation-and-Index]($./01-Data-Preparation-and-Index [DO NOT EDIT]) notebook.

# COMMAND ----------

# MAGIC %md-sandbox
# MAGIC
# MAGIC ## 2/ Deploying a RAG chatbot endpoint with Databricks DBRX Foundation Endpoint
# MAGIC
# MAGIC <img src="https://github.com/databricks-demos/dbdemos-resources/blob/main/images/product/chatbot-rag/llm-rag-self-managed-flow-2.png?raw=true" style="float: right; width: 600px; margin-left: 10px">
# MAGIC
# MAGIC Our data is ready and our Vector Search Index can answer similarity queries, finding documentation page related to our user question.
# MAGIC
# MAGIC We can now create a langchain model with an augmented prompt, accessing the DBRX model to answer advanced Databricks questions.
# MAGIC
# MAGIC **What you will learn:**
...
# MAGIC  %md
# MAGIC Build & Deploy your RAG chatbot : open the [02-Deploy-RAG-Chatbot-Model]($./02-Deploy-RAG-Chatbot-Model [DO NOT EDIT]) notebook.
